...
const experiences = [
  {
    ...
    description:
      'Built a monitoring system for S3 connectivity across 30+ regions, processing 400M+ metrics daily and enabling faster incident response through automated dashboards.',
    technologies: ['AWS', 'React', 'Python', 'TypeScript'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Automated SD-WAN provisioning and network validations, reducing manual work by 400+ hours and accelerating integration cycles.',
    technologies: ['Python', 'Selenium', 'Docker', 'Kubernetes'],
  },
  {
    ...
    period: 'May 2024 – Aug 2024',
    description:
      'Taught Python, HTML, CSS, and C# weekly to 20+ students; hosted two hackathons and graded coursework.',
  ...
  },
  {
    ...
    description:
      'Built a grocery e-commerce app managing 500+ products, streamlining orders, and reducing load times by 30%.',
                ...
                <div className="relative">
                  ...
                  <div
                    className={`ml-12 md:ml-0 ${
                      index % 2 === 0
                        ? 'md:pr-8 md:text-right md:mr-[50%]' // left side
                        : 'md:pl-8 md:ml-[50%]' // right side
                    }`}
                  >
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                            ...
                            <div
                              className={`text-left sm:text-right ${
                                index % 2 === 0 ? 'md:order-1 md:text-left' : 'md:text-right'
                              }`}
                            >
